...
import { AutoRenewIcon, Box, Button, Flex, InjectedModalProps, Modal, Text } from '@plaxswap/uikit'
    ...
    <Modal title={t('Congratulations!')} onDismiss={onDismiss}>
      <Flex flexDirection="column" alignItems="center" justifyContent="center">
        ...
        <Text textAlign="center" bold color="secondary" maxWidth="400px" fontSize="16px" mb="24px">
          {t('You won points for joining Cryptopreneur Community Fund during the first year of our journey!')}
        </Text>
        <Button
          disabled={isLoading}
          onClick={handleClick}
