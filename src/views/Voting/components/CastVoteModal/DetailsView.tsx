...
import { Text, Flex } from '@plaxswap/uikit'
  ...
  return (
    <ModalInner mb="0">
      <Text as="p" mb="24px" fontSize="14px" color="textSubtle">
        {t(
          'Your voting power is determined by the amount of CCF you held at the block detailed below. CCF held in other places does not contribute to your voting power.',
        )}
      </Text>
