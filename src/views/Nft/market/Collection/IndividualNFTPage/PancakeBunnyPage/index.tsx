...
import { Flex } from '@plaxswap/uikit'
...
import { PANCCF_BUNNIES_UPDATE_FREQUENCY } from 'config'
...
const IndividualPancakeBunnyPage: React.FC<IndividualPancakeBunnyPageProps> = ({ bunnyId }) => {
  ...
  useEffect(() => {
    ...
    if (msSinceLastUpdate > PANCCF_BUNNIES_UPDATE_FREQUENCY && !isUpdatingPancakeBunnies && isWindowVisible) {
