...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from '@plaxswap/uikit'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      <Text as="p" color="textSubtle" mb="24px">
        {t('Cost to reactivate in the future: %cost% CCF', { cost: formatBigNumber(numberCakeToReactivate) })}
      </Text>
