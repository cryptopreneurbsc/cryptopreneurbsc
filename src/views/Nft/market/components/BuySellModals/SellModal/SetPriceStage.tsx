...
import { Flex, Grid, Box, Text, Button, BinanceIcon, ErrorIcon, useTooltip } from '@plaxswap/uikit'
...
const SetPriceStage: React.FC<SetPriceStageProps> = ({
  ...
  const { tooltip, tooltipVisible, targetRef } = useTooltip(
    <>
      ...
      <Text>{t('%percentage%% trading fee will be used to buy & burn CCF', { percentage: tradingFee })}</Text>
    </>,
    { placement: 'auto' },
  )
    ...
    <>
      ...
      <Grid gridTemplateColumns="32px 1fr" p="16px" maxWidth="360px">
        ...
        <Box>
          ...
          <Text small color="textSubtle">
            {t('Sales are in WBNB. You can swap WBNB to BNB 1:1 for free with Cryptopreneur Community.')}
          </Text>
        </Box>
      </Grid>
      <Divider />
