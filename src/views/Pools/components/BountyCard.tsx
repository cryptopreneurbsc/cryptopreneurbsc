...
const BountyCard = () => {
  ...
  const TooltipComponent = ({ fee }: { fee: number }) => (
    <>
      ...
      <Text mb="16px">
        {t(
          'Whenever you successfully claim the bounty, you’re also helping out by activating the Auto CCF Pool’s compounding function for everyone.',
        )}
      </Text>
      <Text style={{ fontWeight: 'bold' }}>
        {t('Auto-Compound Bounty: %fee%% of all Auto CCF pool users pending yield', { fee: fee / 100 })}
      </Text>
    </>
  )
