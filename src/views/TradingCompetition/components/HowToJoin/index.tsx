...
import { Flex, Text, Heading } from '@plaxswap/uikit'
  ...
  return (
    <Flex flexDirection="column" maxWidth="736px">
      ...
      <HowToCard number={2} title={t('Battle Time')}>
        <Text fontSize="14px" color="textSubtle">
          {t(
            'Trade BNB/BUSD, CCF/BNB, ETH/BNB and BTCB/BNB during the battle period to raise both your and your team’s score. See the Rules section below for more.',
          )}
        </Text>
      </HowToCard>
