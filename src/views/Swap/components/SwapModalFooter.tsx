...
import { Trade, TradeType } from '@plaxswap/sdkccf'
import { Button, Text, AutoRenewIcon } from '@plaxswap/uikit'
            ...
            <QuestionHelper
              text={
                <>
                  ...
                  <Text>- {t('%amount% towards CCF buyback and burn', { amount: '0.05%' })}</Text>
                </>
              }
              ml="4px"
            />
