...
import { Box, Flex, lightColors, Spinner, Text, Timeline } from '@plaxswap/uikit'
...
const PancakeSquadHeader: React.FC<PancakeSquadHeaderType> = ({
  ...
  return (
    ...
    >
      ...
      <Text color={lightColors.warning} textAlign="center" bold>
        {t('Mint Cost: %minCost% CCF each', {
          minCost: DEFAULT_CCF_COST,
        })}
      </Text>
      <Text color={lightColors.warning} textAlign="center" bold>
      ...
      <Text color={lightColors.invertedContrast} textAlign="center">
        {t('Cryptopreneur Community Fund’s first official generative NFT collection.')}
      </Text>
