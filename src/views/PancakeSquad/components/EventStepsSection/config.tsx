...
import { Button } from '@plaxswap/uikit'
  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active Cryptopreneur Community Fund Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold CCF'),
      bodyText: [t('Each NFT costs CCF to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
