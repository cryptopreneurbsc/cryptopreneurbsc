...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and CCF pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and CCF pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from CCF pool', data)
  }
