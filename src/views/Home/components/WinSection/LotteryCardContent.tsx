...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from '@plaxswap/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in CCF prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with CCF, win CCF if your numbers match')}
        </Text>
      </Flex>
