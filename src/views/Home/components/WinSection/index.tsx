...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@plaxswap/uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'CCF card' },
    { src: 'green', alt: 'Green CCF card with up arrow' },
    { src: 'red', alt: 'Red Cake card with down arrow' },
    { src: 'top-right', alt: 'CCF card' },
  ],
}
